    ...
    <div class="w-100" style="max-width: 400px;">
        ...
        <form action="controller.do?action=register" method="post" novalidate>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" placeholder="Your full name" required autofocus>
            </div>
        ...
        <p class="mt-3 text-center">
            Already have an account? <a href="controller.do?action=login-page">Login here</a>.
        </p>
    </div>
</div>
